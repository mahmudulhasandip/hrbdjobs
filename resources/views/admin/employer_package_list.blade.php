            ...
            <table class="m-datatable" id="scrolling_horizontal" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{--<td>
                            <a href="javascript: void(0);" data-toggle="modal" data-target="#job_modal" class="btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill job_view" data-jobindex="{{ json_encode($package) }}">
                                <i class="la la-eye"></i>
                            </a>
