				 	...
				 	<div class="col-lg-9 column">
				 		<div class="padding-left">
							 ...
							 <form method="POST" role="form" id="newjob" data-toggle="validator" action="{{ route('employer.new.post.job') }}" class="needs-validation" novalidate>
								 @csrf
								 <input type="hidden" name="job_id" value="{{ ($editJob) ? $editJob->id : '' }}">
								<div id="smartwizard">
									<ul>
										...
										<div id="step-1" class="" >
											...
											<div id="form-step-0" data-toggle="validator">
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="title" placeholder="Title" name="title" value="@if (old("title")){{ old('title') }}@elseif ( $editJob ){{ $editJob->title }}@endif" required>
												...
												<div class="form-group row">
													...
													<div class="custom-control custom-checkbox" style="margin-left: 15px;">
														<input type="checkbox" class="custom-control-input" name="is_special" id="special_job"  value="@if (old("is_special")){{ old('is_special') }}@elseif ( $editJob ){{ $editJob->is_special }}@endif" @if (old("is_special")){{ 'checked' }}@elseif ( $editJob['is_special']==1 ){{ 'checked' }} @endif>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select data-validate="true" class="js-example-basic-single" id="job_category_id" name="job_category_id" required>
															...
															<option value="{{ $job_category->id }}" @if(old('job_category_id')){{ old('job_category_id') == $job_category->id ? 'selected' : '' }}@elseif( $editJob && $editJob->job_category_id == $job_category->id ){{ 'selected' }}@endif >{{ $job_category->name }}</option>
															@endforeach
														</select>
														<div class="invalid-feedback">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select class="js-example-basic-single" id="job_designation_id" name="job_designation_id" required>
															...
															<option value="{{ $job_designation->id }}"  @if(old('job_designation_id')){{ old('job_designation_id') == $job_category->id ? 'selected' : '' }}@elseif( $editJob &&  $editJob->job_designation_id == $job_designation->id ){{ 'selected' }}@endif>{{ $job_designation->name }}</option>
															@endforeach
														</select>
														<div class="invalid-feedback">
															Please provide a valid input.
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select class="js-example-basic-single" name="job_status_id" required>
															...
															<option value="{{ $job_status->id }}" @if(old('job_status_id')){{ old('job_status_id') == $job_status->id ? 'selected' : '' }}@elseif( $editJob &&  $editJob->job_status_id == $job_status->id ){{ 'selected' }}@endif>{{ $job_status->name }}</option>
															@endforeach
														</select>
														<div class="invalid-feedback">
															Please provide a valid input.
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select class="js-example-basic-single" name="job_level_id" required>
															...
															<option value="{{ $job_level->id }}" @if(old('job_level_id')){{ old('job_level_id') == $job_level->id ? 'selected' : '' }}@elseif( $editJob &&  $editJob->job_level_id == $job_level->id ){{ 'selected' }}@endif>{{ $job_level->name }}</option>
															@endforeach
														</select>
														<div class="invalid-feedback">
															Please provide a valid input.
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="datepicker" autocomplete="off" placeholder="Deadline" name="deadline"  value="@if (old("deadline")){{ old('deadline') }}@elseif ( $editJob ){{ $editJob->deadline }}@endif" required>
														<div class="invalid-feedback">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" placeholder="Qualification" name="qualification" value="@if (old("qualification")){{ old('qualification') }}@elseif ( $editJob ){{ $editJob->qualification }}@endif">
														<div class="invalid-feedback">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<textarea class="form-control" placeholder="Description" rows="6" id="tinymce" name="description" required>@if (old("description")){{ old('description') }}@elseif ( $editJob ){{ $editJob->description }}@endif</textarea>
														<div class="invalid-feedback">
												...
												@php
													...
													if($editJob){
														...
														foreach ($editJob->jobSkill as $editJobSkill) {

															$editJobSkills[] = $editJobSkill->skill['id'];
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<textarea class="form-control" id="loc" placeholder="Location" name="location" required>@if (old("location")){{ old('location') }}@elseif ( $editJob ){{ $editJob->location }}@endif</textarea>
												...
												<div class="form-group row">
													...
													<div class="custom-control custom-checkbox photo_enclose" style="margin-left: 15px;">
														<input type="checkbox" class="custom-control-input" id="photo" name='is_photograph_enclosed' value="@if (old("is_photograph_enclosed")){{ old('is_photograph_enclosed') }}@elseif ( $editJob ){{ $editJob->is_photograph_enclosed }}@endif" @if (old("is_photograph_enclosed")){{ 'checked' }}@elseif ( $editJob['is_photograph_enclosed']){{ 'checked' }} @endif>
												...
												@php
													...
													if($editJob){
														...
														foreach ($editJob->otherBenifits as $other_benifit) {
													...
													<div class="col-sm-10">
														<select class="js-example-basic-single" multiple="multiple" name="other_benifits[]" >
															<optgroup label="Basic Benifits">
																...
																<option @if(old("other_benifits") && (in_array("Medical Allowance", old("other_benifits")))){{ "selected" }}@elseif( $editJob && in_array("Medical Allowance", $benifits )){{ 'selected' }}@endif value="Medical Allowance">Medical Allowance</option>

																<option @if(old("other_benifits") && (in_array("Performance Bonus", old("other_benifits")))){{ "selected" }}@elseif( $editJob && in_array("Performance Bonus", $benifits )){{ 'selected' }}@endif value="Performance Bonus">Performance Bonus</option>

																<option @if(old("other_benifits") && (in_array("Profit Share", old("other_benifits")))){{ "selected" }}@elseif( $editJob && in_array("Profit Share", $benifits )){{ 'selected' }}@endif value="Profit Share">Profit Share</option>
															...
															<optgroup label="Lunch Facilities">
																<option @if(old("other_benifits") && (in_array("Lunch Partially Subsidize", old("other_benifits")))){{ "selected" }}@elseif( $editJob && in_array("Lunch Partially Subsidize", $benifits )){{ 'selected' }}@endif value="Lunch Partially Subsidize">Partially Subsidize</option>

																<option @if(old("other_benifits") && (in_array("Lunch Full Subsidize", old("other_benifits")))){{ "selected" }}@elseif( $editJob && in_array("Lunch Full Subsidize", $benifits )){{ 'selected' }}@endif value="Lunch Full Subsidize">Full Subsidize</option>
															</optgroup>

															<optgroup label="Salary Review">
																<option @if(old("other_benifits") && (in_array("Salary Review Half Yearly", old("other_benifits")))){{ "selected" }}@elseif( $editJob && in_array("T/A(Transport Allowance)", $benifits )){{ 'selected' }}@endif value="Salary Review Half Yearly">Half Yearly</option>
																<option @if(old("other_benifits") && (in_array("Salary Review Yearly", old("other_benifits")))){{ "selected" }}@elseif( $editJob && in_array("Salary Review Yearly", $benifits )){{ 'selected' }}@endif value="Salary Review Yearly">Yearly</option>
															</optgroup>
										...
										<div id="step-2" class="">
											...
											<div id="form-step-1" data-toggle="validator">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input  type=number step=any class="form-control salary" placeholder="Min. Salary" name="salary_min" value="@if (old("salary_min")){{ old('salary_min') }}@elseif ( $editJob ){{ $editJob->salary_min }}@endif" required>
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
														<div class="help-block with-errors"></div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input  type=number step=any class="form-control salary" placeholder="Max. Salary" name="salary_max" value="@if (old("salary_max")){{ old('salary_max') }}@elseif ( $editJob ){{ $editJob->salary_max }}@endif" required>
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
														<div class="help-block with-errors"></div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select class="form-control" id="salary_type" name="salary_type" required>
															<option value="Weekly"  @if(old('salary_type')){{ old('salary_type') == 'Weekly' ? 'selected' : '' }}@elseif( $editJob &&  $editJob->salary_type == 'Weekly' ){{ 'selected' }}@endif>Weekly</option>
															<option value="Monthly" selected  @if(old('salary_type')){{ old('salary_type') == 'Monthly' ? 'selected' : '' }}@elseif( $editJob &&  $editJob->salary_type == 'Monthly' ){{ 'selected' }}@endif>Monthly</option>
															<option value="Yearly" @if(old('salary_type')){{ old('salary_type') == 'Yearly' ? 'selected' : '' }}@elseif( $editJob &&  $editJob->salary_type == 'Yearly' ){{ 'selected' }}@endif>Yearly</option>
														</select>
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
										...
										<div id="step-3" class="">
											...
											<div id="form-step-2" data-toggle="validator">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" autocomplete="off" placeholder="Preferred University" value="@if (old("preferred_university")){{ old('preferred_university') }}@elseif ( $editJob ){{ $editJob->educationalRequirement['preferred_university'] }}@endif" name="preferred_university">
														<div class="invalid-feedback">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control"  autocomplete="off" placeholder="Others" name="others_edu" value="@if (old("others_edu")){{ old('others_edu') }}@elseif ( $editJob ){{ $editJob->educationalRequirement['others'] }}@endif">
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
														<div class="help-block with-errors"></div>
										...
										<div id="step-4" class="">
											...
											<div id="form-step-3" data-toggle="validator">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input  type=number step=any class="form-control" placeholder="" name="min_experience" value="@if (old("min_experience")){{ old('min_experience') }}@elseif ( $editJob ){{ $editJob->experiencelRequirement['min_experience'] }}@endif" required>
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
														<div class="help-block with-errors"></div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input  type=number step=any class="form-control" placeholder="" name="max_experience" value="@if (old("max_experience")){{ old('max_experience') }}@elseif ( $editJob ){{ $editJob->experiencelRequirement['max_experience'] }}@endif" required>
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
														<div class="help-block with-errors"></div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" autocomplete="off" placeholder="" name="area_of_experience" value="@if (old("area_of_experience")){{ old('area_of_experience') }}@elseif ( $editJob ){{ $editJob->experiencelRequirement['area_of_experience'] }}@endif">
														<div class="invalid-feedback">
															Please provide a valid university.
														</div>
														<div class="help-block with-errors"></div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" autocomplete="off" placeholder="" name="area_of_business" value="@if (old("area_of_business")){{ old('area_of_business') }}@elseif ( $editJob ){{ $editJob->experiencelRequirement['area_of_business'] }}@endif">
														<div class="invalid-feedback">
															Please provide a valid university.
														</div>
														<div class="help-block with-errors"></div>
										...
										<div id="step-5" class="">
											...
											<div id="form-step-4" data-toggle="validator">
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<select class="form-control" id="" required name="gender">
															...
															<option value="0" @if(old('gender')){{ old('gender') == 0 ? 'selected' : '' }}@elseif( $editJob &&  $editJob->gender == 0 ){{ 'selected' }}@endif>All</option>
															<option value="1" @if(old('gender')){{ old('gender') == 1 ? 'selected' : '' }}@elseif( $editJob &&  $editJob->gender == 1 ){{ 'selected' }}@endif>Male</option>
															<option value="2" @if(old('gender')){{ old('gender') == 2 ? 'selected' : '' }}@elseif( $editJob &&  $editJob->gender == 2 ){{ 'selected' }}@endif>Female</option>
															<option value="3" @if(old('gender')){{ old('gender') == 3 ? 'selected' : '' }}@elseif( $editJob &&  $editJob->gender == 3 ){{ 'selected' }}@endif>Others</option>
														</select>
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input  type=number step=any class="form-control" placeholder="Min. Age" name="age_min" value="@if (old("age_min")){{ old('age_min') }}@elseif ( $editJob ){{ $editJob->age_min }}@endif">
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
														<div class="help-block with-errors"></div>
												...
												<div class="form-group row">
													...
													<div class="col-sm-10">
														<input  type=number step=any class="form-control" placeholder="Max. Age" name="age_max" value="@if (old("age_max")){{ old('age_max') }}@elseif ( $editJob ){{ $editJob->age_max }}@endif">
														<div class="invalid-feedback">
															Please provide a valid input.
														</div>
														<div class="help-block with-errors"></div>
        ...
        $('#smartwizard').smartWizard({
			...
			toolbarSettings: {toolbarPosition: 'bottom',
			 					toolbarButtonPosition: 'right',
                                      toolbarExtraButtons: [btnPublish]
                                    },
                    anchorSettings: {
